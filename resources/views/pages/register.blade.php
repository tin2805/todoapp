...
<div class="w3layouts-main">
	<h2>Sign In Now</h2>
        ...
        {{csrf_field()}}
			<input type="email" class="ggg" name="people_email" placeholder="E-MAIL" required="">
            <input type="text" class="ggg" name="people_name" placeholder="Name" required="">
			<input type="password" class="ggg" name="people_password" placeholder="PASSWORD" required="">
            <input type="text" class="ggg" name="people_phone" placeholder="Phone Number" required="">  
